'''
there is lambda for each value in the itarable
return filter which cab ve convert to inti other iterable
the object contains only valuesthat return true to the lambda
'''
